    ...
    <body>
        ...
        <main>
            ...
            <section class="slick-slideshow">
                ...
                <div class="slick-custom">
                    <img src="./images/slideshow/hat.jpg" class="img-fluid" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-12 mt-auto mb-auto">
                            <ul class="nav nav-pills mb-5 mx-auto justify-content-center align-items-center" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-youtube-tab" data-bs-toggle="pill" data-bs-target="#pills-youtube" type="button" role="tab" aria-controls="pills-youtube" aria-selected="true">Hoạt động</button>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-skill-tab" data-bs-toggle="pill" data-bs-target="#pills-skill" type="button" role="tab" aria-controls="pills-skill" aria-selected="false">Hình thức</button>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="tab-content mt-2" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-skill" role="tabpanel" aria-labelledby="pills-skill-tab">
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="images/header/header1.jpg" class="img-fluid" alt="">
                                        </div>
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="product-detail.html" class="product-title-link">Vị Rang Đậm</a>
                                        </h5>
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                ...
                                <div class="product-info d-flex">
                                    ...
                                    <small class="product-price text-muted ms-auto mt-auto mb-5">10.000đ</small>
                                </div>
                            </div>
                        </div>
